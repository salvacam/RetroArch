...
/* Compile: gcc -o picoscale_x192_320x240.so -shared picoscale_x192_320x240.c -std=c99 -O3 -Wall -pedantic -fPIC */
...
#define softfilter_get_implementation picoscale_x192_320x240_get_implementation
#define softfilter_thread_data picoscale_x192_320x240_softfilter_thread_data
#define filter_data picoscale_192x_320x240_filter_data
#endif
...
static unsigned picoscale_x192_320x240_generic_input_fmts(void)
{
   return SOFTFILTER_FMT_RGB565;
}

static unsigned picoscale_x192_320x240_generic_output_fmts(unsigned input_fmts)
{
   return input_fmts;
}

static unsigned picoscale_x192_320x240_generic_threads(void *data)
{
   struct filter_data *filt = (struct filter_data*)data;
   return filt->threads;
}

static void picoscale_x192_320x240_initialize(struct filter_data *filt,
...
static void *picoscale_x192_320x240_generic_create(const struct softfilter_config *config,
      ...
      unsigned threads, softfilter_simd_mask_t simd, void *userdata)
{
   ...
   picoscale_x192_320x240_initialize(filt, config, userdata);

   return filt;
}

static void picoscale_x192_320x240_generic_output(void *data,
      unsigned *out_width, unsigned *out_height,
      unsigned width, unsigned height)
{
   if (((width == 256) || (width == 248)) &&
       (height == 192))
   {
      *out_width  = 320;
      *out_height = 240;
...
static void picoscale_x192_320x240_generic_destroy(void *data)
{
   struct filter_data *filt = (struct filter_data*)data;
   if (!filt) {
      return;
...
static void picoscale_x192_320x240_work_cb_rgb565(void *data, void *thread_data)
{
   struct filter_data *filt           = (struct filter_data*)data;
...
static void picoscale_x192_320x240_generic_packets(void *data,
      ...
      const void *input, unsigned width, unsigned height, size_t input_stride)
{
   ...
   if (filt->in_fmt == SOFTFILTER_FMT_RGB565) {
      packets[0].work = picoscale_x192_320x240_work_cb_rgb565;
   }
   packets[0].thread_data = thr;
}

static const struct softfilter_implementation picoscale_x192_320x240_generic = {
   picoscale_x192_320x240_generic_input_fmts,
   picoscale_x192_320x240_generic_output_fmts,

   picoscale_x192_320x240_generic_create,
   picoscale_x192_320x240_generic_destroy,

   picoscale_x192_320x240_generic_threads,
   picoscale_x192_320x240_generic_output,
   picoscale_x192_320x240_generic_packets,

   SOFTFILTER_API_VERSION,
   "Picoscale_x192-320x240",
   "picoscale_x192_320x240",
};
...
{
   (void)simd;
   return &picoscale_x192_320x240_generic;
}
